...
class IdeaAdmin(admin.ModelAdmin):
    list_display = ('was_submitted_recently', 'enabled', 'featured', 'title', 'private', 'author', 'authorUser', 'thumb', 'active')
    ...
    list_filter = ['subm_date', 'authorUser']
    search_fields = ['title', 'authorUser', 'description']
