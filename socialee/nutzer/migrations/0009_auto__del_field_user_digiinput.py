...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'nutzer_user', 'digiinput',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['nutzer.Digiinput'], unique=True, null=True),
                      keep_default=False)
    ...
    models = {
        u'nutzer.digiinput': {
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'unten'", 'null': 'True', 'to': u"orm['nutzer.User']"})
        },
        u'nutzer.user': {
            'Meta': {'object_name': 'User'},
            'digiinput': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'oben'", 'null': 'True', 'to': u"orm['nutzer.Digiinput']"}),
