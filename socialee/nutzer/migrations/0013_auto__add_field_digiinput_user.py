...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'nutzer_digiinput', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='unten', unique=True, null=True, to=orm['nutzer.User']),
                      keep_default=False)
    ...
    models = {
        u'nutzer.digiinput': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'unten'", 'unique': 'True', 'null': 'True', 'to': u"orm['nutzer.User']"})
        },
        u'nutzer.user': {
